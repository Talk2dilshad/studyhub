...
import { setCourse } from "../../../../slices/courseSlices"
...
export default function NestedView({ handleChangeEditSectionName }) {
  ...
  const handleDeleteSubSection = async (subSectionId, sectionId) => {
    ...
    console.log(result,"delete subsec")
    if (result) {
      // update the structure of course
      const updatedCourseContent = course.courseContent.map((section) =>
        section._id === sectionId ? result : section
      )
      console.log("updated ...",updatedCourseContent)
  ...
  return (
    <>
          ...
          <details key={section._id} open>
            ...
            <summary className="flex cursor-pointer items-center justify-between border-b-2 border-b-richblack-600 py-2">
              ...
              <div className="flex items-center gap-x-3">
                ...
                >
                  <MdEdit className="text-base md:text-xl text-richblack-300" />
                </button>
                <button
                  onClick={() =>
                ...
                >
                  <RiDeleteBin6Line className="text-sm md:text-xl text-richblack-300" />
                </button>
            ...
            <div className="px-4 md:px-5 lg:px-6 pb-4">
              ...
              <button
                ...
                className="mt-3 flex items-center gap-x-1 text-blue-25 text-sm md:text-base"
              >
                <LuFileVideo className="text-lg" />
                <p>Add Lecture</p>
              </button>
            </div>
          </details>
      ...
      {/* Confirmation Modal */}
      {confirmationModal ? (
        <Model modalData={confirmationModal} />
      ) : (
        <></>
      )}
    </>
